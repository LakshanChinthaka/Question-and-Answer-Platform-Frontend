...
function Error403Page() {
    return (
        <div>
            <section class="bg-white mt-20 lg:mt-10 h-full">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-sm text-center">
                        ...
                        <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">We're sorry, but you don't have permission to access this resource. </p>
